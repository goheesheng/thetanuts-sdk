/**
 * ZendFi Module Type Definitions
 *
...
/** Supported ZendFi underlying assets */
export type ZendFiUnderlying = 'ETH' | 'BTC';

/** Per-asset configuration for ZendFi collateral */
export interface ZendFiAssetConfig {
...
export interface ZendFiPromoConfig {
...
export interface ZendFiLoanRequest {
...
export interface ZendFiLoanResult {
  /** Transaction receipt */
...
export interface ZendFiCalculateParams {
...
export interface ZendFiLoanCalculation {
...
export interface ZendFiStrikeSettings {
...
export interface ZendFiStrikeOption {
  /** Strike price in USD */
  strike: number;
...
export interface ZendFiStrikeOptionGroup {
  /** Deribit-style expiry label (e.g. "28MAR25") */
  expiryLabel: string;
  ...
  options: ZendFiStrikeOption[];
}

// ─── On-Chain State ───

/** On-chain loan state from the LoanCoordinator contract */
export interface ZendFiLoanState {
  /** Borrower address */
  requester: string;
...
export interface ZendFiOptionInfo {
...
/** Loan record from the ZendFi indexer API */
export interface ZendFiIndexerLoan {
  /** Quotation ID */
  quotationId: string;
  /** Borrower address */
  requester: string;
...
export interface ZendFiLendingOpportunity {
  /** Quotation ID */
  quotationId: string;
  /** Borrower address */
  requester: string;
