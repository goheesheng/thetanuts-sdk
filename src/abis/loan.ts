/**
 * ZendFi Contract ABIs
 *
 * ABIs for ZendFi's wrapper contracts that sit on top of Thetanuts V4.
 * The SDK already handles OptionFactory and OptionBook ABIs internally.
 */

/** LoanCoordinator — manages loan requests and collateral */
export const ZENDFI_LOAN_COORDINATOR_ABI = [
...
export const ZENDFI_OPTION_ABI = [
  'function exercise()',
...
export const ZENDFI_LOAN_HANDLER_ABI = [
